 ...
 */
public class CViewPager_Adapter extends PagerAdapter
{
    LayoutInflater inflater;

    public CViewPager_Adapter(LayoutInflater inflater) {
    ...
    public Object instantiateItem(ViewGroup container, int position) {
        ...
        //ImageView img= (ImageView)view.findViewById(R.id.tv_viewpager);
        ...
        tv_viewPager.setText("1. 아이와 함께 그동안 솜사탕이 된 기억들을 나눠보세요");
